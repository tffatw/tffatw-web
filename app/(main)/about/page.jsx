...
const timelineItems = [
  ...
  },
  {
    num: 2,
    year: "2006年 - 擴大發展",
    desc: "會員數量增長至100家，協會影響力逐步擴大，成功舉辦首屆行業峰會，吸引了全國各地的行業代表參與。",
  },
  {
    num: 3,
    year: "2010年 - 行業標準制定",
  ...
  },
  {
    num: 5,
    year: "2020年 - 數字化轉型",
    desc: "協會推動行業數字化轉型，設立創新基金，支持會員企業技術創新，提高行業競爭力。",
  },
  {
    num: 6,
    year: "今天 - 繼續前行",
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="w-20 h-1 bg-gradient-to-r from-[#FFB84D] to-[#FFA07A] mb-6 rounded-full" />
      ...
      <section className="py-16 bg-gradient-to-br from-[#F9F9F9] to-[#FFF5E6]">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-[#FFB84D]/20">
              <div className="w-16 h-16 bg-gradient-to-br from-[#FFB84D] to-[#FFA07A] rounded-xl flex items-center justify-center mb-6 shadow-lg">
                <svg
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-[#FFB84D]/20">
              <div className="w-16 h-16 bg-gradient-to-br from-[#4A7C9B] to-[#5B8CAD] rounded-xl flex items-center justify-center mb-6 shadow-lg">
                <svg
                  className="w-8 h-8 text-white"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <div className="space-y-12">
              {timelineItems.map((item) => (
                <div key={item.num} className="relative">
                  <div className="absolute -left-12 md:-left-14 top-0 w-8 h-8 bg-gradient-to-br from-[#FFB84D] to-[#FFA07A] rounded-full flex items-center justify-center shadow-md">
