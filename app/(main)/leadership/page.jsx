...
const brands = [
  {
    id: 1,
    name: "紅橘子",
    logo: "/images/redorange.png",
    category: "餐飲服務",
    description:
      "紅橘子，開啟你幸福的每一天。我們為了幸福而開店，當然也要每天都很幸福。",
    website: "https://www.redorange.com.tw/",
  },
  {
    id: 2,
    name: "少點鹽",
    logo: "/images/saltless.png",
    category: "餐飲服務",
    description:
      "少點鹽健康餐盒專賣，顛覆傳統水煮餐盒印象，當天新鮮食材現烹調，少油少鹽呈現食物的原味，每口都新鮮，簡單卻又不失美味。",
    website: "https://www.healthittaipei.com.tw",
  },
  {
    id: 3,
    name: "喜多生物科技",
    logo: "/images/bio_tech.jpg",
    category: "食品製造商",
    description:
      "喜多以「品質優先」「生產專精」「經營績效」之理念，幾十年來累積許多寶貴的專業經驗提供許多優質產品，並期許以真材實料做食品吃出健康歡喜多服務廣大消費者。",
    website: "https://www.facebook.com/SIDUODRINK8848",
  },
  {
    id: 4,
    name: "艾力卡公司",
    logo: "/images/erica_tech.png",
    category: "供應商",
    description:
      "專業進口咖啡杯、餐盒的紙原料，只要連鎖店需要的杯、餐盒，我有廠商全配合。",
    website: "https://www.twincn.com/item.aspx?no=94021730",
  },
  {
    id: 5,
    name: "快樂波浪紙杯工廠",
    logo: "/images/lodpol.png",
    category: "供應商",
    description:
      "我們是一群來自不同領域的工程師團隊，也是對紙杯製造充滿熱情的創業者，致力研究提升技術，應用科技解決問題。",
  ...
  },
  {
    ...
    category: "餐飲服務",
    description:
      "味亦美秉持著不變的初衷，堅持品質、照顧分店、照顧員工、良心賺錢、回饋社會，一步一腳印的向未來邁進。",
    website: "https://www.facebook.com/wim.tw?locale=zh_TW",
  },
  {
    id: 7,
    name: "東和食品",
    logo: "/images/howmama.jpg",
    category: "食品製造商",
    description:
      "東和食品創立於西元1965年3月，原先以生產農產品外銷，接著加入水產罐頭製造，是首創國內以水產罐頭多樣化產品銷售國外市場之先例。",
    website: "https://www.how-mama.com.tw/?rcode=HZDAUM3H",
  },
  {
    id: 8,
    name: "鮮大王",
    logo: "/images/freshking.jpg",
    category: "食品製造商",
    description:
      '家有鮮大王，清水變雞湯"是我公司希望提供好的產品，讓您的美食更俱色、香、味，同時也讓您的好廚藝更加突出。',
    website: "http://www.freshking.com.tw/default.asp",
  },
  {
    id: 9,
    name: "展安食品",
    logo: "/images/giga_foods.png",
    category: "食品製造商",
    description:
      "成立於 2013 年，遵循創始初心，於食品業界奠定高品質定位。展安堅持以頂級設備及廚藝搭配新鮮、健康、營養的當季食材烹飪出能夠感動您的料理。",
    website: "https://www.gigafoods.com.tw/",
  },
  {
    id: 10,
    name: "樂廚",
    logo: "/images/lechef.png",
    category: "食品製造商",
  ...
  },
  {
    id: 11,
    name: "富甲行銷有限公司",
    logo: "/images/fujia.png",
    category: "顧問服務",
    description:
      "提供專業行銷策略規劃與顧問服務，協助企業打造品牌影響力，開拓市場商機。",
  },
];
...
export default function LeadershipPage() {
  ...
  const filteredBrands =
    currentCategory === "all"
      ? brands
      : brands.filter((b) => b.category === currentCategory);
