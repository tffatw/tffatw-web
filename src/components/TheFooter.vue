    ...
    <div class="container-custom">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li>
              <router-link to="/" class="hover:text-blue-300">首頁</router-link>
            </li>
            <li>
            ...
            <li>
              <router-link to="/leadership" class="hover:text-blue-300"
                >協會領導</router-link
              >
            </li>
            <li>
              <router-link to="/events" class="hover:text-blue-300"
                >活動資訊</router-link
              >
            </li>
            <li>
      ...
      <div class="mt-8 pt-6 border-t border-gray-700 text-center text-sm">
        <p>
          &copy; {{ new Date().getFullYear() }} 台灣速食餐飲協會. 保留所有權利.
        </p>
      </div>
    </div>
  </footer>
