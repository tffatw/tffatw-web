    ...
    <section class="py-16 bg-gray-50">
      <div class="container-custom">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div
            v-for="(chairman, index) in pastChairmen"
            :key="index"
            class="card p-6 text-center"
          >
            <div
              class="w-32 h-32 rounded-full overflow-hidden border-4 border-red-100 mx-auto mb-4"
            >
              <img
                :src="chairman.image"
                :alt="chairman.name"
...
const brands = [
  ...
  },
  {
    ...
    logo: howmamaImg,
    description:
      "東和食品創立於西元1965年3月，原先以生產農產品外銷，包括蜜柑，竹筍，蘆筍、洋菇等罐頭，接著加入水產罐頭製造，是首創國內以水產罐頭多樣化產品銷售國外市場之先例。",
    category: "食品製造商",
  ...
  },
  {
    ...
    logo: gigaFoodsImg,
    description:
      "成立於 2013 年，遵循創始初心，於食品業界奠定高品質定位。 食物，是不可或缺的養分來源，更是提供幸福感的靈魂角色，展安堅持以頂級設備及廚藝搭配新鮮、健康、營養的當季食材烹飪出能夠感動您的料理。",
    category: "食品製造商",
