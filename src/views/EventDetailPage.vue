<template>
  <div>
    <div v-if="loading" class="py-32 text-center">
      <div
        class="inline-block h-12 w-12 border-4 border-red-600 border-t-transparent rounded-full animate-spin"
      ></div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            <div class="md:col-span-8">
              <div class="flex flex-wrap gap-2 mb-4">
                <span
                  class="px-3 py-1 text-sm bg-red-700 text-white rounded-full"
                  >{{ event.type }}</span
                >
                <span
                  :class="[
            ...
            <div class="md:col-span-4">
              <div
                v-if="event.status === '報名中'"
                class="bg-white text-gray-800 p-6 rounded-lg shadow-md"
              >
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="md:col-span-2">
              ...
              <div class="mb-8" v-if="event.images && event.images.length > 0">
                ...
                <div class="flex overflow-x-auto space-x-2 pb-2">
                  <div
                    ...
                    :class="[
                      'cursor-pointer border-2 rounded-md overflow-hidden transition-all w-24 h-24 flex-shrink-0',
                      currentImage === img
                        ? 'border-red-500'
              ...
              <div class="prose max-w-none">
                <template
                  v-for="(block, index) in event.contentBlocks"
                  :key="index"
                >
                  <h3
                    v-if="block.type === 'heading'"
                    :class="`text-xl font-bold mt-6 mb-3`"
                  >
                    {{ block.content }}
                  </h3>
                  <p
              ...
              <div class="sticky top-8">
                ...
                <div class="bg-gray-50 p-6 rounded-lg mb-6">
                  ...
                  <div class="flex space-x-4">
                    <a
                      href="#"
                      class="bg-gray-200 p-2 rounded-full hover:bg-red-100 hover:text-red-600 transition-colors"
                    >
                      <svg
                        class="w-5 h-5"
                        fill="currentColor"
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div class="space-y-3">
                    <div class="flex items-start">
                      <svg
                        class="w-5 h-5 text-gray-600 mt-1 mr-3"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                    ...
                    <div class="flex items-start">
                      ...
                      <span class="text-gray-700">0916-044-823</span>
                    </div>
                  </div>
                </div>
