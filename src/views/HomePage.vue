      ...
      <div class="container-custom">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <router-link
              to="/about"
              class="bg-[#e0725f] btn btn-primary hover:bg-[#d06050]"
              >詳細了解</router-link
            >
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="p-6">
              ...
              <router-link :to="`/events/${event.id}`">
                <h3
                  class="text-xl font-semibold text-gray-800 mb-2 hover:text-red-600 transition-colors"
                >
                  {{ event.title }}
                </h3>
              </router-link>
...
onMounted(() => {
  ...
  setPageMeta({
    title: "首頁",
    description:
      "台灣速食餐飲協會官方網站 - 促進速食連鎖加盟事業健全發展，提供會員教育講習、海外市場經營資訊、供應鏈輔導諮詢等專業服務",
    keywords:
      "台灣速食餐飲協會,速食,餐飲,連鎖加盟,早餐,快餐,行業協會,會員服務,餐飲管理",
