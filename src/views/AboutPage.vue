    ...
    <section class="py-16 bg-gray-50">
      <div class="container-custom">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div class="card p-8">
            <div
              class="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mb-6"
            >
              <svg
      ...
      <div class="container-custom">
        ...
        <div class="relative border-l-4 border-red-600 ml-6 md:ml-8 pl-8 pb-8">
          <div class="space-y-12">
            <div class="relative">
              <div
                class="absolute -left-12 md:-left-14 top-0 w-8 h-8 bg-red-600 rounded-full flex items-center justify-center"
              >
